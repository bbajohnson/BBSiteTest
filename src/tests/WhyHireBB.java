...
public class WhyHireBB {
	...
	@Test
	//Tests the Beta Breakers bread crumb link in the Why Hire page
	public void checkBBBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.whyHirePageURL, Constants.BetaBreakersBreadCrumbLinkXPath,
								  Constants.homePageTitle);
	}
	
	
	@Test
	//Tests the Why Test bread crumb link in the Why Hire page
	public void checkWhyTestBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.whyHirePageURL, "//*[@id='breadcrumbs']/span/span[2]/a",
