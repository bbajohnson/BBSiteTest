...
public class FAQ {
	...
	@Test
	//Tests the Beta Breakers bread crumb link in the FAQ page
	public void checkBBBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.FAQPageURL, Constants.BetaBreakersBreadCrumbLinkXPath,
								  Constants.homePageTitle);
	}
	
	
	@Test
	//Tests the Why Test bread crumb link in the FAQ page
	public void checkWhyTestBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.FAQPageURL, "//*[@id='breadcrumbs']/span/span[2]/a",
