...
public class LaptopLabPage {
	...
	@Test
	//Tests the Beta Breakers bread crumb link in the Laptop Lab testing page
	public void checkBBBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.theLabsLaptopPageURL, Constants.BetaBreakersBreadCrumbLinkXPath,
								  Constants.homePageTitle);
	}
	
	
	@Test
	//Tests the Labs bread crumb link in the Laptop Lab testing page
	public void checkTheLabsBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.theLabsLaptopPageURL, "//*[@id='breadcrumbs']/span/span[2]/a",
