...
public class VideoCardsLabPage {
	...
	@Test
	//Tests the Beta Breakers bread crumb link in the Video Card Lab testing page
	public void checkBBBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.theLabsVideoCardsPageURL, Constants.BetaBreakersBreadCrumbLinkXPath,
								  Constants.homePageTitle);
	}
	
	
	@Test
	//Tests the Labs bread crumb link in the Video Card Lab testing page
	public void checkTheLabsBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.theLabsVideoCardsPageURL, "//*[@id='breadcrumbs']/span/span[2]/a",
