...
public class WhyOutsource {
	...
	@Test
	//Tests the Beta Breakers bread crumb link in the Why Outsource page
	public void checkBBBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.whyOutsourcePageURL, Constants.BetaBreakersBreadCrumbLinkXPath,
								  Constants.homePageTitle);
	}
	
	
	@Test
	//Tests the Why Test bread crumb link in the Why Outsource page
	public void checkWhyTestBreadCrumb(){
		driver = browser.setBrowser("Mozilla");
		
		//Tests link:
		LinkChecker.testWithXpath(driver, Constants.whyOutsourcePageURL, "//*[@id='breadcrumbs']/span/span[2]/a",
